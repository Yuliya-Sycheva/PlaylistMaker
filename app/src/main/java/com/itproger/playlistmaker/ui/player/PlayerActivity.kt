...
//            }
            ...
            private fun startTimer() {
                mainThreadHandler?.postDelayed(
                    object : Runnable {
                        override fun run() {
                          //  val maxTrackDuration: Long = if (playerInteractor.playerDuration > TRACK_FINISH) TRACK_FINISH else playerInteractor.playerDuration.toLong()
                            binding.playTime.text =
                                if (mediaPlayer.currentPosition < TRACK_FINISH) {
                                    SimpleDateFormat(
                                        "mm:ss",
                                        Locale.getDefault()
